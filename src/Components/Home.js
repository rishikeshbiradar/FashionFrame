    ...
    <div ref={codeToCopyRef} className="container mx-auto">
      ...
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="flex items-center">
          <img src={logo} alt="FashionFrame Logo" className="h-12 rounded-full ml-4" />
          <h1 className="text-black text-2xl md:text-xl lg:text-2xl xl:text-3xl font-bold font-serif py-2 my-3 mx-5">FashionFrame</h1>
        </div>
